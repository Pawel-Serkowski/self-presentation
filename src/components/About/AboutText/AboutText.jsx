...
const AboutText = ({ file, variants, inView }) => {
    return (
        <motion.div initial="initial" animate={inView && "animate"} variants={variants} className="textContainer">
            <motion.div className="aboutText" variants={variants}>
                ...
                <p>
                    I <span>dream</span> about becoming a full-stack developer, who can make an application from scratch through sketching
                    project to developing process. I’d love to gain any experience I can and turn it into something beautiful.
                </p>
                <p>
